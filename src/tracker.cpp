...
void ProcessTrackingOutPut(const cv::Mat &image_curr, const BoundingBox &bbox_estimate_uncentered)
{
    cv::Mat full_output;
    ...
    cv::namedWindow("Full Output", cv::WINDOW_AUTOSIZE);
    cv::imshow("Full Output", full_output);
    cv::waitKey(10);
